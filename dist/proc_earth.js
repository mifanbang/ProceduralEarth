...
(function (Astro) {
    ...
    var EarthParam = (function () {
        function EarthParam() {
            ...
            this.colorLand = new THREE.Vector3(0.0329, 0.0669, 0.04);
            this.colorMountain = new THREE.Vector3(0.0887, 0.0529, 0.0062).multiplyScalar(0.8);
            this.colorOcean = new THREE.Vector3(0, 0.0048, 0.087);
            this.cloudAmount = 0;
