...
(function (Astro) {
    var EarthParam = (function () {
        function EarthParam() {
            ...
            this.colorLand = new THREE.Vector3(0.0329, 0.0669, 0.0400);
            this.colorMountain = new THREE.Vector3(0.1020, 0.0625, 0.0639);
            this.colorOcean = new THREE.Vector3(0, 0.0048, 0.0870);
            this.colorSand = new THREE.Vector3(0.2381, 0.2244, 0.1746).multiplyScalar(0.8);
            this.cloudAmount = 0;
    ...
    var Earth = (function (_super) {
        ...
        Earth.prototype.GetUniformFulfillments = function () {
            ...
            return [
                ...
                new Rendering.UniformFulfillment('u_colorSand', function (uni) { return uni.value = param.colorSand; }),
...
(function (Noise) {
    ...
    var FBMTextureRenderable = (function (_super) {
        ...
        FBMTextureRenderable.prototype.GetUniformFulfillments = function () {
            ...
            return [
                ...
                new Rendering.UniformFulfillment('t_prevFbm', function (uni) { return uni.value = _this.texPrevFbm ? _this.texPrevFbm.GetTexture() : undefined; }),
                new Rendering.UniformFulfillment('u_usePrevFbm', function (uni) { return uni.value = _this.texPrevFbm ? _this.texPrevFbm.IsReady() : false; }),
        ...
        FBMTextureRenderable.prototype.SetPrevFBMTex = function (texPrevFbm) {
    ...
    var FBMTexture = (function () {
        ...
        FBMTexture.prototype.SetPrevFBMTex = function (texPrevFbm) {
...
(function (Noise) {
    var AnimatedFBMTextureParam = (function () {
        function AnimatedFBMTextureParam() {
            ...
            this.freqScaler = 1;
            this.step = new THREE.Vector3(1, -1, 1).multiplyScalar(0.03);
