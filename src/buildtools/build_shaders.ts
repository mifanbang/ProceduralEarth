...
function GetFileListWithExt(dir: string, ext: string) : Array<string> {
...
function ConvertToStringLiteral(str: string) : string {
...
function Main() : void {
	let shaderFiles: Array<string> = GetFileListWithExt(CONFIG.inputDir, CONFIG.fileExt);

	let outputCode: Array<string> = ['class ShaderArchive {'];
