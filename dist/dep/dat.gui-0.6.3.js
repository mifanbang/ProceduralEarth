// This file includes additional lines added by Mifan Bang (https://debug.tw).
// Contents that are not part of the original work is commented with the name tag of 'mifanbang'.
...
/***/ function(module, exports, __webpack_require__) {
	...
	var BooleanController = function (_Controller) {
	  ...
	  BooleanController.prototype.updateDisplay = function updateDisplay() {
	    // ADDED BY [mifanbang]
	    if (this.__prev ^ this.getValue())
	      this.__checkbox.click();
	    // END OF ADDITION
